...
namespace GerenciadorImoveis.Dominio.Manipuladores
{
        ...
        IManipuladorComListaArquivos<CadastrarImovelRequisicao, IFormFile>
    {
        public async Task<ResultadoGenerico> Executar(CadastrarImovelRequisicao requisicao, List<IFormFile> listaArquivos)
        {
            ...
            var arquivoMatriculaEntidade = new Arquivo(TipoArquivo.MATRICULA, usuarioResponsavel);
            ...
            //montar matricula
            var matricula = new Matricula(imovel, arquivoMatriculaEntidade, usuarioResponsavel);
            ...
            {
                //montar arquivo entidade
                var arquivoPlantaEntidade = new Arquivo(TipoArquivo.PLANTA, usuarioResponsavel);
                ...
                //montar planta
                var planta = new Planta(imovel, arquivoPlantaEntidade, usuarioResponsavel);
